    ...
    def render_chatbot(self):
        ...
        st.markdown("""
            ...
            .chatbot-header {
                text-align: center;
                padding: 20px;
                background: linear-gradient(90deg, rgba(156, 0, 0, 0.1), rgba(255, 87, 34, 0.1));
                border-radius: 10px;
                margin-bottom: 30px;
            }
            .chat-container {
            ...
            iframe {
                ...
                max-width: 900px; /* Ensuring a max width */
                box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.6); /* Black shadow for depth */
        ...
        st.markdown("""
            <div class="chatbot-header">
                <h1>🤖 Chat with JobLens AI</h1>
                <p>Ask anything about resume, career advice, or job applications!</p>
            </div>
        """, unsafe_allow_html=True)

        chatbot_url = "https://bots.easy-peasy.ai/bot/3fc33ec7-6d64-4437-a693-73708cca91af?mode=iframe"
